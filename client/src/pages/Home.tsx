...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Symptoms Section - Matching Reference Layout */}
      <section 
      ...
      >
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-[60%] flex items-center py-8 px-8 lg:px-16">
            <div className="space-y-5 w-full">
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-luxury-serif font-bold leading-tight" style={{ color: '#4a5d47' }}>
                <span className="font-normal">Reset</span> Your Body
              </h3>
              <p className="text-base md:text-lg" style={{ color: '#5a6d57' }}>
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-4 pt-2">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#7a9a76' }}>
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
                    </svg>
                  </div>
                  <span className="font-bold text-base md:text-lg" style={{ color: '#4a5d47' }}>Can't Lose Weight</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-base md:text-lg" style={{ color: '#4a5d47' }}>Brain Fog</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-base md:text-lg" style={{ color: '#4a5d47' }}>Memory Issues</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-base md:text-lg" style={{ color: '#4a5d47' }}>Trouble Sleeping</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-base md:text-lg" style={{ color: '#4a5d47' }}>Inflamed</span>
                </div>
              </div>
              ...
              <div className="pt-3">
                <a
                  href={generalCheckoutUrl}
                  className="inline-flex items-center justify-center px-10 py-3 text-base font-bold rounded-full shadow-md transition-all hover:shadow-lg hover:scale-105"
