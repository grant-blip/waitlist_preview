...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Symptoms Section - Full Width Split Layout */}
      <section className="w-full overflow-hidden" style={{ backgroundColor: 'rgb(149, 165, 145)' }}>
        <div className="grid grid-cols-1 lg:grid-cols-3">
          {/* Left Side - Image (1/3) - Edge to Edge */}
          <div className="lg:col-span-1 h-48 lg:h-auto">
            <img
          ...
          <div className="lg:col-span-2 flex items-center py-6 px-6 lg:px-12">
            <div className="text-white space-y-3 w-full">
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-luxury-serif font-bold leading-tight">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-3 pt-2">
              ...
              <div className="pt-2">
                <a
                  href={generalCheckoutUrl}
                  className="inline-flex items-center justify-center px-6 py-2.5 text-base font-bold rounded-full shadow-md transition-all hover:shadow-lg hover:scale-105"
