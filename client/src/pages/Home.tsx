...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="py-4 md:py-5" style={{ backgroundColor: 'rgb(149, 165, 145)' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-4 lg:gap-6 items-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center lg:justify-start">
              <img
                ...
                className="w-full max-w-[180px] lg:max-w-[220px] h-auto rounded-lg shadow-md object-cover"
              />
            </div>

            {/* Right Side - Content */}
            <div className="text-white space-y-2">
              <h3 className="text-xl md:text-2xl font-luxury-serif font-bold leading-tight">
              ...
              <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 pt-1">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-xs md:text-sm">Can't Lose Weight</span>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-xs md:text-sm">Brain Fog</span>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-xs md:text-sm">Memory Issues</span>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-semibold text-xs md:text-sm">Trouble Sleeping</span>
                </div>
                ...
                <div className="flex items-center gap-1.5 col-span-2 md:col-span-1">
                  ...
                  <span className="font-semibold text-xs md:text-sm">Inflamed</span>
                </div>
              </div>
              ...
              <div className="pt-1">
                <a
                  href={generalCheckoutUrl}
                  className="inline-flex items-center justify-center px-5 py-2 text-sm font-bold rounded-full shadow-md transition-all hover:shadow-lg hover:scale-105"
